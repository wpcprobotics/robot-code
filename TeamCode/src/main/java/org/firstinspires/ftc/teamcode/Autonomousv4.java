...
@Autonomous(name="Autonomous Wall", group="Pushbot")
//@Disabled
public class Autonomousv4 extends LinearOpMode {
    ...
    static final double     COUNTS_PER_MOTOR_REV    = 1440;    // Changed from Tetrix to Nevarest 60 Motor Encoder
    ...
    static final double     DISTANCE_BETWEEN_WHEELS = 12.5;
